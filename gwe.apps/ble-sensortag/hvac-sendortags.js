...
// Static methods
SensorTag.decimalToHex = function(decimal, chars) {
	return (decimal + Math.pow(16, chars)).toString(16).slice(-chars).toUpperCase();
}
SensorTag.sensorTagUUID_gen = function(idv) {
...
SensorTag.prototype.enable = function() {
...
SensorTag.prototype.disable = function() {
	if (this._controlCharacteristic && this._dataCharacteristic) {
		var buff = new Buffer(1);
		buff.writeUInt8(0);
		this._controlCharacteristic.write(buff, false, function(err){
...
SensorTag.prototype.latest = function() {
